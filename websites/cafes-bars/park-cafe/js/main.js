...
document.querySelectorAll('[data-mailto-form]').forEach((form) => {
  form.addEventListener('submit', (e) => {
    ...
    const lines = [
      ...
      get('bericht') || '—',
      '',
      '— Verstuurd via park-cafe.nl'
    ];
    const body = lines.join('\n');
    const url = `mailto:info@park-cafe.nl?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
