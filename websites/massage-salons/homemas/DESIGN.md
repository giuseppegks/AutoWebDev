# DESIGN.md — HomeMas (afgeleid van Gerrit Jonker Massage blueprint)

> Design system voor de HomeMas-site. Identiek qua palet/typografie aan de Gerrit Jonker Massage blueprint waar deze instance van is afgeleid — alle waarden hieronder zijn 1-op-1 overgenomen.
>
> **HomeMas-specifieke verschillen:** wordmark `np` i.p.v. `gj`, geen `#kanker`-sectie, zes behandelingen incl. Pedicure (Chinese Tui Na, Voetreflex, Hotstone, Ontspanning, Tapen, Pedicure).
...
**Logo-mark:** wordmark "Gerrit Jonker" + tagline "Massage" in tracking-kicker. Geen apart logobestand — typografie is het logo. Kleine ronde "gj"-mark in koper-rand-cirkel ernaast.
...
- **Toon:** Direct, lichaamsbewust, rustig. Gebruikt "ik" (Gerrit zelf) i.p.v. "wij" — het is een 1-op-1 praktijk.
...
- `images/` — leeg, foto's worden geladen van gerritjonkermassage.nl WP CDN
...
| Aspect | Royal Thai | Gerrit Jonker |
|---|---|---|
| Palet | Burgundy-deep + warm gold | Earth-deep + warm bronze/koper |
| Locaties | Twee (Arnhem + Nijmegen) | Eén (Nijmegen-Oost) |
